  ...
  return (
    <aside className="hidden w-64 flex-col border-r border-sidebar-border bg-sidebar md:flex">
      ...
      <nav className="flex flex-1 flex-col gap-1 overflow-y-auto px-3 py-2" aria-label="Dashboard navigation">
        ...
        {/* Ticketing Section - visible to organizers/staff */}
        {canOrganize && (
          <>
            <div className="my-3 border-t border-sidebar-border" />
            <p className="mb-1 px-3 text-[10px] font-semibold uppercase tracking-wider text-sidebar-foreground/40">
            ...
            {TICKETING_ITEMS.map((item) => {
              const isActive = item.href === "/dashboard/ticketing"
                ? pathname === "/dashboard/ticketing"
                : pathname.startsWith(item.href)
        ...
        {/* Team Section - visible to admins/owners */}
        {isManager && (
          <>
            <div className="my-3 border-t border-sidebar-border" />
            <p className="mb-1 px-3 text-[10px] font-semibold uppercase tracking-wider text-sidebar-foreground/40">
