...
const events = [
  { name: "test 10", slug: "test-10", start_date: "2026-03-28 00:20:00+00" },
  { name: "Test 9", slug: "test-9", start_date: "2026-03-28 20:00:00+00" },
  { name: "Test Paid Event 1", slug: "test-paid-event-1", start_date: "2026-04-30 19:00:00+00" },
]
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#0a0a0a;padding:40px 20px;">
    <tr><td align="center">
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;">
        ...
        <tr><td style="background-color:#141414;border-radius:12px;border:1px solid #2a2a2a;overflow:hidden;">
          <table width="100%" cellpadding="0" cellspacing="0">
            <tr><td style="padding:28px 32px 20px;border-bottom:1px solid #2a2a2a;">
              ...
              <h1 style="margin:0;font-size:22px;font-weight:700;color:#ffffff;line-height:1.3;">You are registered for ${events.length} upcoming events</h1>
            </td></tr>
            <tr><td style="padding:20px 32px 8px;">
              <p style="margin:0;color:#a3a3a3;font-size:15px;line-height:1.6;">Hey ${firstName}, just a reminder that you have the following tournaments coming up. Make sure you are ready to compete.</p>
            </td></tr>
            <tr><td style="padding:16px 32px 24px;">
              <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #2a2a2a;border-radius:8px;overflow:hidden;">
                ...
                <tbody style="background-color:#141414;">${eventsHtml}</tbody>
              </table>
            </td></tr>
            <tr><td style="padding:0 32px 32px;text-align:center;">
              <a href="${BASE_URL}/esports/tournaments" style="display:inline-block;background-color:#eab308;color:#0a0a0a;font-weight:700;font-size:14px;text-decoration:none;padding:12px 28px;border-radius:8px;">View My Events</a>
            </td></tr>
          </table>
        </td></tr>
        <tr><td style="padding:24px 0;text-align:center;">
          <p style="margin:0;font-size:12px;color:#525252;">You are receiving this because you registered on <a href="${BASE_URL}" style="color:#eab308;text-decoration:none;">majhevents.com</a>.</p>
        </td></tr>
      </table>
    </td></tr>
  </table>
