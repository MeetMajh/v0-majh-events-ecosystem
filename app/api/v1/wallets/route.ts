...
export async function GET(req: Request) {
  ...
  try {
    ...
    // 4. Get wallet summary from ledger
    ...
    if (error) {
      console.error("[API v1/wallets] RPC error:", error)
      return apiError("internal_error", "Failed to fetch wallet summary")
    }
    ...
    console.error("[API v1/wallets] Error:", err)
